...
def test_describe_utci_collection():
    assert (
        ...
        == 'For Jun 01 to Mar 31 between 00:00 and 23:00, "No thermal stress" is expected for 2633'
        ' out of a possible 7296 hours (36.1%). "Cold stress" is expected for 4655 hours (63.8%). '
        '"Heat stress" is expected for 8 hours (0.1%).'
    )
