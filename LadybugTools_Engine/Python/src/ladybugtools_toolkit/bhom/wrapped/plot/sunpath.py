...
def sun_path(epw_file, analysis_period, size, return_file: str, save_path):
    try:
        ...
        from ladybugtools_toolkit.bhom.wrapped.metadata.sunpath_metadata import \
            sunpath_metadata
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description=("Given an EPW file path, create a plot of its' sun path")
    )
    parser.add_argument(
        "-e",
        "--epw_file",
