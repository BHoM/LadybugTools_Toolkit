...
def windrose(
    ...
    try:
        ...
        from ladybugtools_toolkit.bhom.wrapped.metadata.wind_metadata import \
            wind_metadata
        ...
        wind_filtered = w_epw.filter_by_analysis_period(
            analysis_period=analysis_period)

        w_epw.filter_by_analysis_period(
            analysis_period=analysis_period).plot_windrose(
            ax=ax, directions=bins, ylim=(
                0, 3.6 / bins), colors=colour_map)
