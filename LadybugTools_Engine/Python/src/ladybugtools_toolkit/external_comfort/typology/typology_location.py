...
class TypologyLocation:
    ...
    def __init__(
        ...
        sky_view_factor_shaded: float = 1,
    ...
    def mean_radiant_temperature(
        ...
        _sun_exposure = self.sun_exposure_location(simulation_result.epw, sun_hours)
        mrts = []
