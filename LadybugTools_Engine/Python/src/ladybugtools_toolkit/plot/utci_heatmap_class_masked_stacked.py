...
def utci_heatmap_class_masked_stacked(
    collection: HourlyContinuousCollection, title: str = None, show_legend: bool = True, UTCIColor: UTCIColorScheme = UTCIColorSchemes.UTCI_Original, 
