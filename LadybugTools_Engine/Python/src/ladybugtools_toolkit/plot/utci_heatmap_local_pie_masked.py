...
def utci_heatmap_local_pie_masked(
    ...
    series_cut = pd.cut(series_adjust, bins=[-100] + UTCI_LOCAL_LEVELS + [100], labels=UTCI_LOCAL_LABELS)
    ...
    if title is None:
        ...
        pie_ax.set_title(pie_title, color="k", size="small")
