...
def cloud_cover_categories(epw: EPW, ax: plt.Axes = None, style_context:str = "python_tookit.bhom") -> plt.Axes:
...
def hours_sunlight(location: Location, ax: plt.Axes = None, style_context:str = "python_toolkit.bhom") -> plt.Axes:
...
def hours_sunrise_sunset(location: Location, ax: plt.Axes = None, style_context:str = "python_toolkit.bhom") -> plt.Axes:
...
def solar_elevation_azimuth(location: Location, ax: plt.Axes = None, style_context:str = "python_toolkit.bhom") -> plt.Axes:
