...
MODEL_FILE = Path(__file__).parent / "files" / "example.hbjson"
EPW_FILE = Path(__file__).parent / "files" / "example.epw"
EPW_CSV_FILE = (Path(__file__).parent / "files" / "example.csv",)
